...
\setbox\ltmcbox\vbox{
	...
	\noindent \begin{longtable}{p{0.12\columnwidth}p{0.8\columnwidth}} 
		...
		$B$ &  coefficients stored after sparsity transformation ($B\leq O$)\\ \hline
...
\inlvar{sparsityIndices} & \inltab{Integer} & $ J \times C \times W \times B$ & \inlvar{isSparsityTransformed} & Indices of the coefficients (between $1$ and $O$)\\ \hline
