...
$O$ &  Number of acquired frames without background frames\\ \hline
...
\inlvar{numSamplingPoints} & \inltab{Int64} & $1$ &  & no & Number of sampling points within a cycle over all \inlvar{numPeriods} drive-field periods denoted by $V$ \\ \hline
