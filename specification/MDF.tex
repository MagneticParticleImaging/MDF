...
\inlvar{isFourierTransformed} & \inltab{Int8} & 1 & & yes & flag indicating if the data is stored in frequency space \\ \hline
...
\inlvar{isTransposed} & \inltab{Int8} & 1 & & yes & flag indicating of the Dimension $Q$ has been moved to ...\\ \hline 
\inlvar{framePermutation} & \inltab{Int64} & $Q$ & & yes & Index vector indicating a permutation of the $Q$ frames\\ \hline 
