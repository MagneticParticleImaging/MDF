...
$K$ &  Number of frequencies desscribing processed data (usually $K=L$ if no bandwidth reduction has been done)\\ \hline
$W$ &  Number of sampling points for processed data (usually $W=V$ except when a bandwidth reduction has been done)\\ \hline
