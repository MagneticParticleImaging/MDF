...
\setbox\ltmcbox\vbox{
	...
	\noindent \begin{longtable}{p{0.12\columnwidth}p{0.8\columnwidth}} 
		...
		$W$ &  sampling points used to store processed data (usually $W=V$ except when a bandwidth reduction has been done)\\ \hline
		$K$ &  frequencies describing processed data (usually $K=\frac{V}{2}+1$ if no frequency selection has been done)\\ \hline
		$L$ &  frequencies describing the transfer function (usually $L=K$)\\ \hline
		&\\
