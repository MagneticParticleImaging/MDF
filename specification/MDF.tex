...
\textbf{Parameter} & \textbf{Type} & \textbf{Dim} & \textbf{U/F} & \textbf{Optional} & \textbf{Description} \\ \hline 
...
\inlvar{numFrames} & \inltab{Integer} & 1 &  & no & Number of available measurement frames, denoted by $O$ \\ \hline
\inlvar{isSpectralLeakageCorrected} & \inltab{Int8} & 1 & & no & flag indicating if spectral leakage correction has been applied \\ \hline
\inlvar{isFrameSelection} & \inltab{Int8} & 1 & & no & flag indicating if the processed data contains only a selection of the raw data \\ \hline
...
\inlvar{isFrequencySelection} & \inltab{Int8} & 1 & & no & flag indicating if frequencies have been selected \\ \hline 
\inlvar{isFramePermution} & \inltab{Int8} & 1 & & no & flag indicating if the order of frames have been changes \\ \hline 
\inlvar{isTransposed} & \inltab{Int8} & 1 & & no & flag indicating of the Dimension $O$ has been moved to ...\\ \hline
\inlvar{frequencySelection} & \inltab{Integer} & K & & yes & Indices of selected frequency components \\ \hline
...
\inlvar{numAverages} & \inltab{Integer} & $O$ & & yes & Number of raw data frames contained in each data frame \\ \hline
