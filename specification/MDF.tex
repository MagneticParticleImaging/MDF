...
\setbox\ltmcbox\vbox{
	...
	\noindent \begin{longtable}{p{0.12\columnwidth}p{0.8\columnwidth}} 
		...
		$W$ &  sampling points containing processed data (\mbox{$W=V$} if no frequency selection or bandwidth reduction has been done)\\ \hline
		$K$ &  frequencies describing processed data ($K=V/2+1$ if no frequency selection or bandwidth reduction has been done)\\ \hline
		&\\
