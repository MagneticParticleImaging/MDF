...
\noindent \begin{tabularx}{\columnwidth}{llp{3cm}llX} 
\textbf{Parameter} & \textbf{Type} & \textbf{Dim} & \textbf{Unit/Format} & \textbf{Optional} & \textbf{Description} \\ \hline 
\inlvar{processedData} & \inltab{Number} & $Q \times J \times C \times K\times 2$ & & yes & Processed data stored in frequency domain representation \\ \hline 
\inlvar{processedDataTransposed} & \inltab{Number} & $ J \times C \times K\times Q \times 2$ & & yes & As processed data but transposed \\ \hline
