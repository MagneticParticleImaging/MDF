...
\author{
T.~Knopp$^{1,2}$, T.~Viereck$^{3}$, G.~Bringout$^{4}$, M.~Ahlborg$^{4}$, J.~Rahmer$^5$, M.~Hofmann$^{1,2}$ \\ \\
...
$^4$Institute of Medical Engineering, University of  Lübeck, Germany\\
$^5$Philips GmbH Innovative Technologies, Research Laboratories, Röntgenstraße 24-26, 22315 Hamburg, Germany
}
