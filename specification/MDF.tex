...
\inlvar{transferFunction} & \inltab{Float64} & $C \times L \times 2$ & \inlvar{unit}$\cdot$A$^{-1}$$\cdot$m$^{-2}$& yes & Transfer function of the receive channels in Fourier Domain\\ \hline
\end{tabularx}
