...
\subsection{Extension / Custom Parameters}
...
\paragraph{Remarks:} TODO The study description group describes the experimental setting under which the MPI data was recorded. The study field may be used as a name tag for several experiments, which are related. 
...
TODO describe multi bolus.... $A$ is the number of used tracers/bolii
...
\begin{itemize}
	...
	\item Rename \inlvar{/study/simulation} to \inlvar{/study/isSimulation} for consistency reasons. Furthermore, the type has changed to \inlvar{Int8}.
