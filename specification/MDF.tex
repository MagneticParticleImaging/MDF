...
\setbox\ltmcbox\vbox{
	...
	\noindent \begin{longtable}{p{0.12\columnwidth}p{0.8\columnwidth}} 
		...
		$N$ &  acquired frames ($N=O+E$), same as a spatial position for calibration\\ \hline
		$E$ &  acquired background frames ($E=N-O$)\\ \hline
		$O$ &  acquired foreground frames ($O=N-E$)\\ \hline
...
\inlvar{sparseDataIndices} & \inltab{Integer} & $ J \times C \times W \times B$ & \inlvar{isSparsityTransformed} & Indices of the coefficients (between $1$ and $O$)\\ \hline
